...
public class SplashScreen extends CordovaPlugin {
  ...
  public void adjustScale() {
    ...
    DisplayMetrics SamsungTabS6 = new DisplayMetrics() {{
      densityDpi = DisplayMetrics.DENSITY_XHIGH;
      widthPixels = 1600;
      heightPixels = 2560;
    }};
    ...
    if (!isMaintainAspectRatio() ||
      ...
      (config.orientation == Configuration.ORIENTATION_PORTRAIT && isDevice(metrics, SamsungTabS6, true)) ||
      (config.orientation == Configuration.ORIENTATION_LANDSCAPE && (metrics.densityDpi >= DisplayMetrics.DENSITY_HIGH && metrics.densityDpi <= DisplayMetrics.DENSITY_XXXHIGH))
    ) {
